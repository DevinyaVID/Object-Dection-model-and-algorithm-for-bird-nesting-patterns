...
def process_video():
    ...
    for result in model(video_path, stream=True):
        ...
        label_filename = os.path.join(LABELS_FOLDER, f"frame_{frame_count:04d}.txt")
        with open(label_filename, "w") as f:
            for box in result.boxes:
                ...
                # Write in the normalized format
                f.write(f"{class_id} {confidence:.4f} {x_center:.4f} {y_center:.4f} {box_width:.4f} {box_height:.4f}\n")
